...
void encode(char *buff, long size, char *outfile, long outfile_size, struct code code_list[256], int count[256], int symbol_nr) {
...
int main(int argc, char **argv) {
	...
	encode(buff, size, outfile, outfile_size, code_list, count, heap_size);
